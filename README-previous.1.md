...
The 4naly3er report can be found [here](https://github.com/code-423n4/2024-11-blueprint/blob/main/4naly3er-report.md).
Slither's output can be found [here](https://github.com/code-423n4/2024-11-blueprint/blob/main/slither.txt).
...
- **Previous audits:** [Earn V1_SSC.pdf](https://github.com/code-423n4/2024-11-blueprint/blob/main/Earn%20V1%20_%20SSC.pdf)
...
_See [scope.txt](https://github.com/code-423n4/2024-11-blueprint/blob/main/scope.txt)_
...
| /src/interfaces/IConcreteMultiStrategyVault.sol | ****| 1 | 37 | |@openzeppelin/contracts/interfaces/IERC4626.sol|
...
| /src/strategies/Aave/AaveV3Strategy.sol | 1| **** | 74 | |@openzeppelin/contracts/token/ERC20/extensions/ERC4626.sol<br>@openzeppelin/contracts/utils/math/Math.sol|
...
| /src/strategies/ProtectStrategy/ProtectStrategy.sol | 2| **** | 87 | |@openzeppelin/contracts/token/ERC20/extensions/ERC4626.sol<br>@openzeppelin/contracts/utils/math/Math.sol|
...
| /src/strategies/Radiant/RadiantV2Strategy.sol | 1| **** | 91 | |@openzeppelin/contracts/token/ERC20/extensions/ERC4626.sol<br>@openzeppelin/contracts/utils/math/Math.sol|
...
| /src/strategies/Silo/SiloV1Strategy.sol | 1| **** | 132 | |@openzeppelin/contracts/token/ERC20/extensions/ERC4626.sol<br>@openzeppelin/contracts/utils/math/Math.sol|
| /src/strategies/StrategyBase.sol | 1| **** | 176 | |@openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC4626Upgradeable.sol<br>@openzeppelin/contracts/proxy/utils/Initializable.sol<br>@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol<br>@openzeppelin/contracts/utils/math/Math.sol<br>@openzeppelin/contracts/utils/ReentrancyGuard.sol<br>@openzeppelin/contracts-upgradeable/utils/PausableUpgradeable.sol<br>@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol|
| /src/strategies/compoundV3/CompoundV3Strategy.sol | 1| **** | 73 | |@openzeppelin/contracts/token/ERC20/extensions/ERC4626.sol<br>@openzeppelin/contracts/utils/math/Math.sol|
...
| /src/vault/ConcreteMultiStrategyVault.sol | 1| **** | 657 | |@openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC4626Upgradeable.sol<br>@openzeppelin/contracts/utils/ReentrancyGuard.sol<br>@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol<br>@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol<br>@openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.sol<br>@openzeppelin/contracts-upgradeable/utils/PausableUpgradeable.sol<br>@openzeppelin/contracts/utils/math/Math.sol|
| **Totals** | **26** | **37** | **2803** | | |

### Files out of scope

_See [out_of_scope.txt](https://github.com/code-423n4/2024-11-blueprint/blob/main/out_of_scope.txt)_
...
Single admin on Earn contracts (OnlyOwner) .. because we use multisig
...
| Question                                | Answer                       |
| --------------------------------------- | ---------------------------- |
| [ConcreteMultiStrategyVault.sol](https://github.com/code-423n4/2024-11-blueprint/blob/main/src/vault/ConcreteMultiStrategyVault.sol)                         | ERC4626             |
| [StrategyBase.sol](https://github.com/code-423n4/2024-11-blueprint/blob/main/src/strategies/StrategyBase.sol)                       | ERC4626                 |
...
```bash
git clone --recurse https://github.com/code-423n4/2024-11-blueprint.git
cd 2024-11-blueprint
forge build
forge test
forge coverage
```
